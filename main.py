...
def turn_off_music():
    global is_play_music, off_music
    if is_play_music:
        pygame.mixer.music.pause()
        off_music = True
        is_play_music = False
...
class Main_Menu:
    ...
    def __init__(self):
        self.background = pygame.transform.scale(load_image('images/background_menu.png'),
                                                 (width_screen, height_screen))
    ...
    while running:
        ...
        if current_type_tab == 'Game':
            ...
            pygame.draw.rect(screen, (128, 128, 128),
                             pygame.Rect(10 + player.health * 2, 10, 200 - player.health * 2, 50),
                             width=0)
